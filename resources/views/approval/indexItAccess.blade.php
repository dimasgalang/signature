                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="flex-row">
                                                <a id="show-view" class="btn btn-primary btn-circle btn-sm show-view" data-view-document="{{route('it-access-request.approve', $approval->id_request_access)}}" data-download-document="{{ route('it-access-request.view', $approval->id_request_access) }}">
