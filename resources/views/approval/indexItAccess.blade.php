                            ...
                            <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><center><a id="show-comment" class="btn btn-warning btn-icon-split btn-sm show-comment" data-toggle="modal" data-target="#commentModal" data-comment-url="{{ route('it-access-request.fetchitaccess', $approval->id) }}">
                                        ...
                                        <td class="d-flex flex-row justify-content-center align-items-center">
                                            {{-- <div class="flex-row"> --}}
                                                <a id="show-view" class="btn btn-primary btn-circle btn-sm show-view mx-1" data-view-document="{{route('it-access-request.approve', $approval->id_request_access)}}" data-download-document="{{ route('it-access-request.view', $approval->id_request_access) }}">
                                                    <i class="fas fa-eye"></i>
                                                </a>
    
                                                @if($approval->preparer_id == Auth::user()->id && ($approval->approval_progress < '2' || $approval->status == 'revision'))
                                                    <a href="{{route('it-access-request.edit', $approval->id_request_access)}}" class="btn btn-warning btn-circle btn-sm mx-1">
                                                ...
                                                @if (request()->get('void') == 'false' || request()->get('void') == '')
                                                    @if ($approval->approval_level == $approval->approval_progress)
                                                        @if ($approval->approval_progress === '3' && $approval->status == 'pending')
                                                                <a id="show-revision" class="btn btn-warning btn-circle btn-sm show-revision mx-1" data-revision-url="{{ route('it-access-request.fetchitaccess', $approval->id) }}" data-revision-link="{{ route('it-access-request.revision') }}" data-revision-name="{{ $approval->document_name }}" data-preparer-name="{{ $approval->preparer_id }}" data-date-name="{{ $approval->created_at }}" data-toggle="modal" data-target="#revisionModal">
