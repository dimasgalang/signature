    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form method="post" action="{{ route('approval.approved') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <input class="form-control" type="hidden" id="signature_img" name="signature_img" value="{{ $user[0]->signature_img }}" readonly>
