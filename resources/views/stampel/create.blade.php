        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Create Stampel</h1>
                </div>
                

                <!-- Approach -->
                <form method="post" action="{{ route('stampel.store') }}" enctype="multipart/form-data">
                 <div class="row">
                    <div class="col-lg-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Form Create Stampel</h6>
                            </div>
                            <div class="card-body">
                                    @csrf
...
<script type="text/javascript">
    function addRecords() {
        $("#stampelInput").append('<div class="row"><br><br><div class="col-xl-9"><select class="form-control stampel_id" id="stampel_id" name="stampel_id[]">@foreach($users as $user)<option value="{{ $user->id }}">{{ $user->name }}</option>@endforeach</select></div><div class="col-xl-3"><button type="button" class="btn btn-danger btn-block removeThis">Remove</button></div></div>');
        $('.stampel_id').select2({
            allowClear: true,
            placeholder: 'Choose Stampel',
        });
    }
