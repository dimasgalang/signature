        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Stampel</h1>
                </div>
                <form method="post" action="{{ route('stampel.stamping') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <input class="form-control" type="hidden" id="id" name="id" value="{{ $stampel[0]->id }}" readonly>
                                <input class="form-control" type="hidden" id="url" name="url" value="{{ url()->current() }}" readonly>
                                <input class="form-control" type="hidden" id="token" name="token" value="{{ $stampel[0]->token }}" readonly>
                                <input class="form-control" type="hidden" id="base64" name="base64" value="{{ $stampel[0]->base64 }}" readonly>
                                <input class="form-control" type="hidden" id="preparer_id" name="preparer_id" value="{{ $stampel[0]->preparer_id }}" readonly>
                                <input class="form-control" type="hidden" id="stamp_img" name="stamp_img" value="oeko.png" readonly>
                                <input class="form-control" type="hidden" id="original_name" name="original_name" value="{{ $stampel[0]->original_name }}" readonly>
                                <label>Document Name : </label>
                                <input class="form-control" type="text" id="document_name" name="document_name" value="{{ $stampel[0]->document_name }}" readonly>
                                <br>
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id=parent>
                                    <div class="draggable-2"><img src="{{ asset('/storage/signature/oeko.png') }}" width="100%" height="100%"></div>
...
<script>
    ...
    $(document).ready(function() {
        var file = document.getElementById('base64').value
        // console.log(file)
