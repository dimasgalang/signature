        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Deactivate User Account List</h1>
                    <div>
                    ...
                    <a href="{{ route('cyber-user.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-plus fa-sm text-white-50"></i> Create Deactivate User Account</a>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                        <h6 class="m-0 font-weight-bold text-primary">Deactivate User Account</h6>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach($deactivateRequests as $deactivateRequest)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $deactivateRequest->deactivation_request_id }}</td>
                                        <td>{{ $deactivateRequest->date_of_request }}</td>
                                        <td>{{ $deactivateRequest->employee_name }}</td>
                                        <td>{{ $deactivateRequest->employee_dept }}</td>
                                        <td>{{ $deactivateRequest->document_name }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
