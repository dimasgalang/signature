                        ...
                        <div class="row">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" type="text" id="document_name" name="document_name" value="{{$commitment->document_name}}" required readonly>
                                            <input class="form-control" type="hidden" id="original_name" name="original_name" value="{{$commitment->original_name}}">
                                            <input class="form-control" type="hidden" id="base64" name="base64" value="{{$commitment->base64}}">
                                            <input class="form-control" type="hidden" id="type" name="type" value="commitment">
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-6">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <iframe src="{{$commitment->base64}}" id="pdfPreview" width="100%" height="500px"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
