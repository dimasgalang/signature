                                    ...
                                    <tr>
                                        ...
                                        <td class="row justify-content-center">
                                            ...
                                            @if($purchaseRequest->status == 'waiting' && (Auth::user()->getRoleNames()->first() == 'Purchase' || Auth::user()->getRoleNames()->first() == 'Admin'))
                                                <a href="{{ route('purchase-requestion.assignSupplier', $purchaseRequest->purchase_requestion_number) }}" class="btn btn-sm btn-circle btn-info btn-process-record mx-1"><i class="fas fa-sync"></i></a>
