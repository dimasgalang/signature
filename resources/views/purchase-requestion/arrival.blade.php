                                ...
                                <div id="employmentIdentity">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <input class="form-control" type="text" id="name" name="name" value="{{ $purchaseRequests[0]->employee_id }}" readonly>
                                        </div>
                                        <div class="col-xl-3">
                                ...
                                <div id="itemRequest">
                                    <div class="row">
                                        <div class="col-xl-4">
                                            ...
                                            <input class="form-control" type="hidden" id="id_barang" name="id_barang" value="{{ $purchaseRequests[0]->id }}">
                                            <input class="form-control" type="text" id="item_name" value="{{ $purchaseRequests[0]->nm_barang }}" readonly>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <input class="form-control" type="number" id="qty" name="quantity_receiver" >
