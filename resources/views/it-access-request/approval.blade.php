                                        ...
                                        @foreach ($hardwareRequests as $key => $hardwareRequest)
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <select class="form-control hardware_id" id="hardware_id" name="hardware_device[{{$key}}][hardware_name]" readonly>
                                                        <option></option>
                                                ...
                                                <div class="col-xl-3 mb-2">
                                                    ...
                                                    <input class="form-control" type="number" id="qty" name="hardware_device[{{$key}}][quantity]" value="{{ $hardwareRequest->qty }}" readonly>
                                                </div>
                                                @if (Auth::user()->id == '1')
                                                    <div class="col-xl-3 mb-2">
                                    ...
                                    @foreach ($fileFolderAccesses as $key => $fileFolderAccess)
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <input class="form-control" type="text" id="file_folder_access" value="{{ $fileFolderAccess->file_folder_name }}" name="file_folder_access[{{$key}}][file_folder_access]" readonly>
                                            </div>
                                        ...
                                        @foreach ($userAccounts as $key => $userAccount)
                                            <div class="row">
                                                <div class="col-xl-8">
                                                    ...
                                                    <input class="form-control" type="text" id="account_name" name="user_account[{{$key}}][account_name]" value="{{ $userAccount->account_name }}" readonly>
                                                </div>
                                                @if (Auth::user()->id == '1')
                                    ...
                                    @foreach ($emailAccount as $key => $emailAddress)
                                        <div class="row">
                                            <div class="col-xl-3">
                                                ...
                                                <input class="form-control" type="text" id="email_address" name="email_address[{{$key}}][email_address]" value="{{ $emailAddress->email_address }}" readonly>
                                            </div>
                                            <div class="col-xl-3">
                                                <label>Purpose :</label>
                                                <textarea class="form-control" id="purpose" name="email_address[{{$key}}][purpose]" readonly>{{ $emailAddress->purpose }}</textarea>
                                            </div>
                                            <div class="col-xl-3">
                                                <label>Restriction :</label>
                                                <textarea class="form-control" id="restriction" name="email_address[{{$key}}][restriction]" readonly>{{ $emailAddress->restriction }}</textarea>
                                            </div>
                                            ...
                                            @foreach ($applicationPrograms as $key => $applicationProgram)
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        ...
                                                        <input class="form-control" type="text" id="application_name" name="application_program[{{$key}}][application_name]" value="{{ $applicationProgram->application_name }}" readonly>
                                                    </div>
                                                    <div class="col-xl-4">
                                                        <label>Login Name :</label>
                                                        <input class="form-control" type="text" id="login_name" name="application_program[{{$key}}][login_name]" value="{{ $applicationProgram->login_name }}" readonly>
                                                    </div>
                                                    @if (Auth::user()->id == '1')
                                                        <div class="col-xl-4 mb-2">
                                                            {{-- buatkan select untuk approve dan tolak --}}
                                        ...
                                        @foreach ($internetAccess as $key => $internetAccess)
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    ...
                                                    <textarea class="form-control" id="purpose" name="internet_access[{{$key}}][purpose]" readonly>{{ $internetAccess->purpose }}</textarea>
                                                </div>
                                                <div class="col-xl-4">
                                                    <label>Restriction :</label>
                                                    <textarea class="form-control" id="restriction" name="internet_access[{{$key}}][restriction]" readonly>{{ $internetAccess->restriction }}</textarea>
                                                </div>
                                                @if (Auth::user()->id == '1')
                                                    <div class="col-xl-4 mb-2">
                                                        {{-- buatkan select untuk approve dan tolak --}}
                                        ...
                                        @foreach ($otherRequests as $key => $otherRequest)
                                            <div class="row">
                                                <div class="col-xl-3">
                                                    ...
                                                    <input class="form-control" type="text" id="other_request" name="other_request[{{$key}}][other_request]" value="{{ $otherRequest->other_request }}" readonly>
                                                </div>
                                                <div class="col-xl-3">
                                                    <label>Purpose :</label>
                                                    <textarea class="form-control" id="purpose" name="other_request[{{$key}}][purpose]" readonly>{{ $otherRequest->purpose }}</textarea>
                                                </div>
                                                <div class="col-xl-3">
                                                    <label>Restriction :</label>
                                                    <textarea class="form-control" id="restriction" name="other_request[{{$key}}][restriction]" readonly>{{ $otherRequest->restriction }}</textarea>
                                                </div>
                                                @if (Auth::user()->id == '1')
                                                    <div class="col-xl-3 mb-2">
                                                        {{-- buatkan select untuk approve dan tolak --}}
